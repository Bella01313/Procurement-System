    ...
    return (
        <div className='bg-white w-full flex fixed top-0 justify-between items-center p-4 '>
            ...
            <ul className='hidden lg:flex gap-[3rem] justify-center  items-center'>
                <Link to="/" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg p-2 font-bold flex "> Home</a>
                    </li>
                </Link>
                <Link to="/about" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg p-2 font-bold flex"> About</a>
                    </li>
                </Link>
                <Link to="/service" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg p-2 font-bold  flex"> Service</a>
                    </li>
                </Link>
     
                <Link to="/tenders" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg p-2 font-bold   flex"> Tenders</a>
                    </li>
                </Link>
                <Link to="/contact" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg p-2 font-bold  lg:mr-[7rem] flex"> Contact</a>
                    </li>
                </Link>
                <Link to="/login" >
                    <li className="mb-4">
                        <a href="#" className="text-black hover:text-white hover:bg-green-600 rounded-lg  lg:mr-[7rem] p-2 font-bold bg-green-600 px-[2rem] flex">Login</a>
                    </li>
                </Link>
            </ul>
